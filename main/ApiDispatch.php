...
use tkight\utility\NamingStyle;
...
class ApiDispatch extends Dispatch
{
    ...
    public function init(App $app)
    {
        ...
        $app->http->name($this->rule->getOption('app', strtolower($vars['app']) ?? 'index')); // 应用名
        $this->controller = NamingStyle::snakeToPascal($vars['controller']).'Controller'; // 控制器
        $this->actionName = NamingStyle::snakeToCamel($vars['action']); // 操作名
    ...
    public function controller(string $name)
    {
        ...
        $class = "\\app\\$appName\\$controllerLayer\\$name";
